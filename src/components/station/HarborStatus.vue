    ...
    <div class="card">
        <header class="card-header">
            <p class="card-header-title">
                <button
                    v-if="HarborStatus === false"
                    class="button is-rounded is-danger"
                    @click="getHarborStatus()"
                >
                    <i class="fas fa-ship" />
                </button>
                <button
                    v-if="HarborStatus === true"
            ...
            <button
                ...
                @click="HarborStatusMoreInformation=!HarborStatusMoreInformation"
            >
                <span class="icon">
                    <i
                        v-if="HarborStatusMoreInformation === false"
                        class="fas fa-angle-down"
                        aria-hidden="true"
                    />
                    <i
                        v-if="HarborStatusMoreInformation === true"
