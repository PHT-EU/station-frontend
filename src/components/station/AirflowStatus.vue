    ...
    <div class="card">
        <header class="card-header">
            <p class="card-header-title">
                <button
                    v-if="AirflowStatus === false"
                    class="button is-rounded is-danger"
                    @click="getAirflowStatus()"
                >
                    <i class="fas fa-wind" />
                </button>
                <button
                    v-if="AirflowStatus === true"
            ...
            <button
                ...
                @click="AirflowStatusMoreInformation=!AirflowStatusMoreInformation"
            >
                <span class="icon">
                    <i
                        v-if="AirflowStatusMoreInformation === false"
                        class="fas fa-angle-down"
                        aria-hidden="true"
                    />
                    <i
                        v-if="AirflowStatusMoreInformation === true"
