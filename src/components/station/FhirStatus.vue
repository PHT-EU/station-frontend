    ...
    <div class="card">
        <header class="card-header">
            ...
            <button
                ...
                @click="FhirStatusMoreInformation=!FhirStatusMoreInformation"
            >
                <span class="icon">
                    <i
                        v-if="FhirStatusMoreInformation === false"
                        class="fas fa-angle-down"
                        aria-hidden="true"
                    />
                    <i
                        v-if="FhirStatusMoreInformation === true"
        ...
        >
            <div class="content">
                <div class="block has-text-left">
                    <div
                        v-for="FhirSever in FhirSeverList"
                        :key="FhirSever.name"
                    >
    ...
    methods: {
        async getFhirStatus() {
            ...
            axios.get(url).then((response) => {
                ...
                for (const index in this.FhirSeverList) {
